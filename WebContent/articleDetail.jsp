<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.sql.*,com.xue.bbs.utils.*,java.util.*,com.xue.bbs.pojo.*,com.xue.bbs.bean.*"%>
...
<%
	...
	*/
	...
	//获取rootid，就是属于哪个帖子的内容都要展现出来  | 为了session检查 防止报错，为null赋值为-1
	...
	if (str != null && str.equals("success") && rootid != -1) {
		ShowArticleDeal.showArticleDeal(list, rootid);
	} else {
				...
				<tbody>
					<tr valign="top">
						<td width="99%">
							...
							<p class="jive-page-title"> 主题：<%=list.get(0).getTitle() %> </p>
						</td>
						<td width="1%">
																				...
																				<table border="0" cellpadding="0" cellspacing="0">
																					<tbody>
																						<tr>
																							...
																							<td class="jive-icon-label">
																								<!-- 回复主题 -->
																								<a href="reply.jsp?id=<%=ar.getId() %>&rootid=<%=ar.getRootid() %>" title="回复本主题">回复</a>
																							</td>
																						</tr>
																					</tbody>
																				</table>
