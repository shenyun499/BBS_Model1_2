<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.sql.*,com.xue.bbs.utils.*,java.util.*,com.xue.bbs.pojo.*,com.xue.bbs.beanflat.*"%>
...
<%
	...
	*/
	...
	//获取pid，作为rootid，就是属于哪个帖子的内容都要展现出来  | 为了session检查 防止报错，为null赋值为-1
			...
			<div class="jive-buttons">
				<table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
					<tbody>
						<tr>
							<td class="jive-icon">
								<a href="http://bbs.chinajavaworld.com/post%21reply.jspa?threadID=744236"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a>
							</td>
							<td class="jive-icon-label">
								<a id="jive-reply-thread" href="replyFlat.jsp?id=<%=id %>&rootid=<%=id %>">回复本主题</a>
							</td>
						</tr>
					</tbody>
				</table>
																				...
																				<table border="0" cellpadding="0" cellspacing="0">
																					<tbody>
																						<tr>
																							<td></td>
																							<td class="jive-icon">
																								<a href="http://bbs.chinajavaworld.com/post%21reply.jspa?messageID=780144" title="回复本主题"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a>
																							</td>
																							<td class="jive-icon-label">
																								<!-- 回复主题 -->
																								<a href="replyFlat.jsp?id=<%=ar.getId() %>&rootid=<%=ar.getRootid() %>" title="回复本主题">回复</a>
																							</td>
																						</tr>
																					</tbody>
																				</table>
